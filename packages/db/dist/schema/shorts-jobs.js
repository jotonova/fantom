...
export const shortsJobs = pgTable('shorts_jobs', {
    ...
    motionHints: jsonb('motion_hints').$type(),
    ...
    tenantScheduledIdx: index('shorts_jobs_tenant_scheduled_idx').on(table.tenantId, table.scheduledFor),
}));
