...
export const distributions = pgTable('distributions', {
    ...
    tenantStatusCreatedAtIdx: index('distributions_tenant_status_created_at_idx').on(table.tenantId, table.status, table.createdAt),
    jobIdx: index('distributions_job_idx').on(table.jobId),
    statusCreatedAtIdx: index('distributions_status_created_at_idx').on(table.status, table.createdAt),
}));
