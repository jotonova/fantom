...
export const assemblyaiUsage = pgTable('assemblyai_usage', {
    ...
    tenantCreatedAtIdx: index('assemblyai_usage_tenant_created_at_idx').on(table.tenantId, table.createdAt),
